...
public class TurnoServiceTests extends IntegrationTests {
    ...
    void consultarDisponibilidad_obtieneDisponibilidadDeProfesional() {
        ...
        DisponibilidadDTO disponiblidad = turnoService.consultarDisponibilidad(profesional.getId(), fecha.getDayOfWeek());
    ...
    void consultarDisponibilidad_profesionalNoExiste_lanzaExcepcion() {
        ...
        EntityNotFoundException ex = assertThrows(EntityNotFoundException.class, () -> {
            turnoService.consultarDisponibilidad(idInexistente, LocalDate.now().getDayOfWeek());
        });
    ...
    void consultarDisponibilidad_sinDisponibilidad_lanzaExcepcion() {
        ...
        EntityNotFoundException ex = assertThrows(EntityNotFoundException.class, () -> {
            turnoService.consultarDisponibilidad(profesional.getId(), LocalDate.now().getDayOfWeek());
        });
    ...
    void consultarDisponibilidad_turnosOcupados_noIncluyeHorasReservadas() {
        ...
        DisponibilidadDTO result = turnoService.consultarDisponibilidad(profesional.getId(), fecha.getDayOfWeek());
